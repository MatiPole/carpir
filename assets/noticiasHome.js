        ...
        <div id="${carouselId}" class="carousel carousel-fix slide carousel-fade" data-bs-ride="carousel" data-bs-interval="2500">
          <div class="carousel-inner">
            <div class="carousel-item active">
              <img src="assets/img/${noticia.img[0]}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/img/${noticia.img[1]}" class="d-block w-100" alt="...">
            </div>
            <div class="carousel-item">
              <img src="assets/img/${noticia.img[2]}" class="d-block w-100" alt="...">
            </div>
          </div>
